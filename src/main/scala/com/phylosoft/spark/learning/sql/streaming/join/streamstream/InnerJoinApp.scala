...
import com.phylosoft.spark.learning.sql.streaming.join.streamstream.AppConfig.TRIGGER_POLICY
import com.phylosoft.spark.learning.sql.streaming.join.streamstream.AppConfig.TRIGGER_POLICY.TRIGGER_POLICY
